; (function ($) {
  $(document).ready(function () {
    ...
    // Check if the progress path element exists before trying to use it
    if (progressPath) {
  ...
  // *** CORRECTED SECTION ***
  // This function now safely checks if the element exists before trying to style it.
  function updateProgress(selector, value) {
    ...
    if (element) {
      ...
      // Optional: Log a warning to the console for debugging
      // console.warn('Element not found for selector:', selector);
    }
  }

  // These calls will now not crash the script if the elements are not on the page
